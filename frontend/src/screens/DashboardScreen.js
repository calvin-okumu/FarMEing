        ...
        <>
            ...
            >
                ...
                <StitchSurface style={styles.pulseCard} contentStyle={styles.pulseContent} tone='raised' compact>
                    ...
                    <View style={styles.pulseGridRow}>
                        <MetricBlock label={t('dashboard.revenue')} value={formatCurrency(summary.totalRevenue, currency)} note={t('dashboard.sale_records', { count: filteredSales.length })} icon='cash-outline' accent={colors.primaryContainer} reversed />
...
const styles = StyleSheet.create({
    ...
    scopeBar: { marginBottom: spacing.sm, marginHorizontal: 16 },
    scopeBarContent: { backgroundColor: colors.surfaceHighlight, gap: spacing.xs },
    scopeBarLabel: { fontSize: type.caption.fontSize, lineHeight: type.caption.lineHeight, color: colors.textMuted, fontWeight: '800', textTransform: 'uppercase', letterSpacing: 0.8 },
    scopeBarValue: { fontSize: type.cardTitle.fontSize, lineHeight: type.cardTitle.lineHeight, fontWeight: '800', color: colors.text },
    scopeBarMeta: { fontSize: type.caption.fontSize, lineHeight: 15, color: colors.textMuted },
    scopeBarChips: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.xs, marginTop: spacing.xs },

    pulseCard: { marginBottom: spacing.sm, marginHorizontal: 16 },
    ...
    pulseEyebrow: { fontSize: type.caption.fontSize, lineHeight: type.caption.lineHeight, color: colors.accentBrown, fontWeight: '800', letterSpacing: 1, textTransform: 'uppercase' },
    ...
    pulseBadgeText: { fontSize: 9, fontWeight: '800', color: colors.primaryContainer, textTransform: 'uppercase', letterSpacing: 0.6 },
    ...
    pulseBudgetLabel: { fontSize: 10, color: colors.textMuted, fontWeight: '700', textAlign: 'right' },
    ...
    metricBlockLabel: { fontSize: 9, fontWeight: '800', color: colors.textMuted, textTransform: 'uppercase', letterSpacing: 0.7 },
    metricBlockValue: { fontSize: 17, fontWeight: '900', color: colors.text, letterSpacing: -0.3 },
    metricBlockNote: { marginTop: 1, fontSize: 9, color: colors.textMuted, fontWeight: '600' },
  ...
  miniStatLabel: { fontSize: 9, fontWeight: '700', color: colors.textMuted, textTransform: 'uppercase', letterSpacing: 0.5, flex: 1 },
