...
const styles = StyleSheet.create({
  ...
  phoneFrame:   { width: '92%', maxWidth: 390, minHeight: 790, backgroundColor: stitchTheme.colors.background, borderRadius: 42, borderWidth: 8, borderColor: stitchTheme.colors.text, paddingHorizontal: 22, paddingTop: 10, paddingBottom: 18, overflow: 'hidden' },
  ...
  title:        { fontSize: 34, lineHeight: 36, fontWeight: '900', color: stitchTheme.colors.primary },
  subtitle:     { fontSize: 15, lineHeight: 22, color: stitchTheme.colors.accentBrown, marginTop: 10, maxWidth: 270 },
  ...
  eyeBtn:       { padding: 4 },
  btn:          { marginTop: 22, backgroundColor: stitchTheme.colors.primary, borderRadius: 18, height: 58, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 10, ...stitchShadows.float },
