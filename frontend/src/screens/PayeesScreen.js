...
const styles = StyleSheet.create({
  ...
  cardTop: { flexDirection: 'row', alignItems: 'center', gap: stitchTheme.spacing.sm, paddingLeft: 18, paddingRight: 14 },
  avatar: { width: 44, height: 44, borderRadius: stitchTheme.radius.sm, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(26,61,43,0.12)' },
  avatarText: { color: stitchTheme.colors.primaryContainer, ...stitchTheme.typography.cardTitle, letterSpacing: -0.5 },
  cardMeta: { flex: 1 },
  payeeName: { ...stitchTheme.typography.cardTitle, color: stitchTheme.colors.text, letterSpacing: -0.3 },
  payeeCategory: { ...stitchTheme.typography.eyebrow, color: stitchTheme.colors.accentBrown },
  badge: { paddingHorizontal: 9, paddingVertical: 4, borderRadius: stitchTheme.radius.pill },
  badgeText: { ...stitchTheme.typography.eyebrow, letterSpacing: 0.8 },
  divider: { height: 1, backgroundColor: stitchTheme.colors.line, marginVertical: stitchTheme.spacing.sm, marginHorizontal: 18, opacity: 0.8 },
  ...
  cardBottom: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end', paddingLeft: 18, paddingRight: 14 },
  metaGroup: { flex: 1 },
  metaGroupEnd: { alignItems: 'flex-end', minWidth: 52 },
  metaLabel: { ...stitchTheme.typography.eyebrow, color: stitchTheme.colors.textMuted, marginBottom: 2 },
  metaValue: { ...stitchTheme.typography.cardDescription, fontWeight: '800', color: stitchTheme.colors.text },
  statusPill: { flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: stitchTheme.colors.mintLight, paddingHorizontal: 10, paddingVertical: 8, borderRadius: stitchTheme.radius.pill, marginLeft: 'auto' },
  ...
  statusText: { ...stitchTheme.typography.eyebrow, color: stitchTheme.colors.primaryContainer, letterSpacing: 0.4 },
