...
const styles = StyleSheet.create({
  ...
  cardTop: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingLeft: 18, paddingRight: 14 },
  ...
  divider: { height: 1, backgroundColor: stitchTheme.colors.line, marginVertical: 12, marginHorizontal: 18, opacity: 0.8 },
